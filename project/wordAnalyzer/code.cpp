...
std::vector<token> getTokens(std::string filename){ 
    ...
    while(!input->getInput().empty()){ 
        ...
        if(_1009(input)) {token newtoken; newtoken.name = "_1009"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_50(input)) {token newtoken; newtoken.name = "_50"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_51(input)) {token newtoken; newtoken.name = "_51"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_52(input)) {token newtoken; newtoken.name = "_52"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_53(input)) {token newtoken; newtoken.name = "_53"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_54(input)) {token newtoken; newtoken.name = "_54"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_55(input)) {token newtoken; newtoken.name = "_55"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_56(input)) {token newtoken; newtoken.name = "_56"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_57(input)) {token newtoken; newtoken.name = "_57"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_58(input)) {token newtoken; newtoken.name = "_58"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_59(input)) {token newtoken; newtoken.name = "_59"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_60(input)) {token newtoken; newtoken.name = "_60"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_61(input)) {token newtoken; newtoken.name = "_61"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_62(input)) {token newtoken; newtoken.name = "_62"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_63(input)) {token newtoken; newtoken.name = "_63"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_64(input)) {token newtoken; newtoken.name = "_64"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_65(input)) {token newtoken; newtoken.name = "_65"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_66(input)) {token newtoken; newtoken.name = "_66"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_67(input)) {token newtoken; newtoken.name = "_67"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_68(input)) {token newtoken; newtoken.name = "_68"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_69(input)) {token newtoken; newtoken.name = "_69"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        if(_70(input)) {token newtoken; newtoken.name = "_70"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
        ...
        if(_15(input)) {token newtoken; newtoken.name = "_15"; newtoken.value = input->getTokenWord(pos);  tokens.push_back(newtoken); input->goBackOneChar(); continue; }  
        else input->goBack(pos);
