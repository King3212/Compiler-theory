...
int main(int argc, char *argv[]){
    ...
    //testIdentifier();
    //testKeyword();
    //string filename = "/home/mirror/Documents/Compiler-theory/lab1/GUI-VERSION/Lab-build/qrc_qmake_qmake_qm_files.cpp";
    string filename = "/home/mirror/Desktop/temp.cpp";
    testFile(filename);
